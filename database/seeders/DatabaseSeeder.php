...
class DatabaseSeeder extends Seeder
{
    ...
    echo "\n";
    UserSubscription::factory(150)->create();
    ...
    echo "\n";
    UserMilestone::factory(150)->create();
    ...
    echo "Banner created";
    echo "\n";
    Follow::factory(150)->create();
    echo "Follow created";
    echo "\n";
    Bookmark::factory(150)->create();
    echo "Bookmark created";
    echo "\n";
    Wallet::factory(150)->create();
    echo "Wallet created";
    echo "\n";
    CommissionSetting::factory(10)->create();
    $itemType = [ClassModel::class,WebinarRecording::class,Bundle::class,User::class,Event::class];
